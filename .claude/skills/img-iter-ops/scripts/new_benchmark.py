        ...
        "score_dimensions": [
            {"dim": "consistency", "desc": "三视图跨张一致性：同产品/同色/几何比例一致",
             ...
             "check_items": ["C1 三视图是同一产品", "C2 三视图颜色一致",
                             "C3 侧视与正视几何尺寸一致(不预设具体形态)", "C4 各视图高度比例一致",
                             "C5 每个视图完整呈现整个产品(正视/侧视/立体各自完整,无截断/不显示局部)"]},
            {"dim": "product_structure", "desc": "产品结构：部件数/位置/形态正确，无缺失/重复/穿模",
             "weight_init": 0.22, "ref_needed": True, "scoring_type": "binary",
             "check_items": ["S1 整体结构忠实还原参考图(对照target自由对比各部件形态/数量/位置/比例)",
                             "S2 无部件穿模/重叠", "S3 无部件缺失/多余",
                             "S4 整体造型轮廓忠实还原参考图(对照target判断,不预设具体形态)"]},
